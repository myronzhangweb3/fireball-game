...
# --- 游戏性 ---
FIREBALL_SPEED = 40         # 火球飞行速度 (值越大, 速度越快)
DEFAULT_HEALTH = 15         # 默认生命值
PLAYER_COOLDOWN = 0.5       # 玩家发射火球后的冷却时间 (秒)
AI_MIN_COOLDOWN = 0.5       # AI发射火球的最小间隔时间 (秒)
AI_MAX_COOLDOWN = 1.5       # AI发射火球的最大间隔时间 (秒)
...
# --- AI 行为 ---
AI_ANIMATION_SPEED = 0.2    # AI上下移动动画的速度 (值越大, 移动越快)
AI_ANIMATION_RANGE = 120     # AI上下移动的范围 (像素)
